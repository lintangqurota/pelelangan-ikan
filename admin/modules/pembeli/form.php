...
if ($_GET['form']=='add') { ?>
	...
	<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<a href="?module=pembeli">Pembeli</a>
			</li>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/pembeli/proses.php?act=insert" method="POST" />
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-2 col-md-10">
							...
							&nbsp; &nbsp; 
							<a style="width:100px" href="?module=pembeli" class="btn">Batal</a>
						</div>
					</div>
				</form>
				<!--PAGE CONTENT ENDS-->
...
elseif ($_GET['form']=='edit') { 
	if (isset($_GET['id'])) {
	    ...
	    $query = mysqli_query($mysqli, "SELECT * FROM pembeli WHERE id_pembeli='$_GET[id]'") 
...
?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/pembeli/proses.php?act=update" method="POST" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="col-xs-12 col-sm-5" name="nama" autocomplete="off" value="<?php echo $data['nama_pembeli']; ?>" required />
						</div>
					</div>
